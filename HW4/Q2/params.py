...
class Params:
  ...
  attn_type: str = 'cosine'
  lr: float = 0.01  # learning rate
  adagrad_accumulator: float = 0.1
  lr_decay_step: int = 1  # decay lr every how many epochs?
  lr_decay: Optional[float] = 0.8#None  # decay lr by multiplying this factor
  batch_size: int = 16
  n_batches: int = 100  # how many batches per epoch
