...
devDataPath = os.path.join("corpus", "HW1_v2", "CSEP517-HW1-Data-Full", "brown.dev.txt")
trainDataPath = os.path.join("corpus", "HW1_v2", "CSEP517-HW1-Data-Full", "brown.train.txt")
testDataPath = os.path.join("corpus", "HW1_v2", "CSEP517-HW1-Data-Full", "brown.test.txt")
